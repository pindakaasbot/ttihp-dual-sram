...
| Branch | Tile | Die Area (um²) | Macro % | Logic Area (um²) | GDS | GL Test |
|--------|------|---------------|---------|------------------|-----|---------|
| `6macro-4x4` | **4x4** | 607,019 | 49.8% | 304,645 | **FAIL** | — |
| `6macro-5x4` | **5x4** | 761,537 | 39.7% | 459,163 | **PASS** | **PASS** |
| `main` | **6x4** | 916,110 | 33.0% | 613,736 | **PASS** | **PASS** |
...
| Branch | Tile | Die Area (um²) | Macro % | Logic Area (um²) | GDS | GL Test |
|--------|------|---------------|---------|------------------|-----|---------|
| `dual-512x64-4x4` | **4x4** | 607,019 | 49.4% | 306,815 | **PASS** | **PASS** |
| `dual-512x64` | **8x2** | 540,907 | 55.5% | 240,703 | **PASS** | **PASS** |
| — | 6x4 | 916,110 | 32.8% | 615,906 | — | — |
| — | 8x4 | 1,224,682 | 24.5% | 924,478 | — | — |

Note: R90 doesn't fit in 4x4 (784.48 > 710.64 height). N orientation works for 512×64.
6x4 and 8x4 not CI-tested — shown for comparison only.
...
~230um above for standard cell logic.
...
Stacked vertically. ~465um of unused width to the right, ~240um above.
Logic area: 615,906 um² (67.2% of die). Very spacious but wasteful.
...
Side by side with ~46um gap. ~480um of height above macros for logic.
...
| Branch | Config | Tile | Orientation | GDS | GL Test | Notes |
|--------|--------|------|-------------|-----|---------|-------|
| `dual-512x64-4x4` | B (2 macros) | 4x4 | N | **PASS** | **PASS** | Smallest working tile |
| `dual-512x64` | B (2 macros) | 8x2 | N | **PASS** | **PASS** | Digital tile option |
| `6macro-5x4` | A (6 macros) | 5x4 | R90 | **PASS** | **PASS** | Smallest for 6-macro |
| `main` | A (6 macros) | 6x4 | R90 | **PASS** | **PASS** | Comfortable fit |
| `6macro-4x4` | A (6 macros) | 4x4 | R90 | **FAIL** | — | PDN-0179: right margin too tight (19um) |
